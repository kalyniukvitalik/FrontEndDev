(function(global, libName) {
    ...
    function Timer(props = {}) {
        // this = {}
        // this.__proto__ = Ti,er.prototype
    ...
    Timer.prototype.startRenderInterval = function startRenderInterval() {
        ...
        this.actionCol.stop.disabled = false;
    };

    Timer.prototype.stopRenderInterval = function stoptRenderInterval() {
             clearInterval(this._intervalID);
             this._intervalID = null;
             this.actionCol.stop.disabled = true;
    ...
    Timer.prototype.runRenderInterval = function runRenderInterval() {
        this.currentTime = setInterval(this.render.bind(this), 1000);
    };
